...
class Monde:
    ...
    def creerJoueur(self):
        ...
        self.joueur = V.Vaisseau(self,self.fenetre,800,900,63,self.Vaisseau,self.LARGEUR,self.HAUTEUR,self.enemy_list_object,self.enemy_list_image)

        self.fenetre.ZoneDeJeu.bind('<Key>',self.joueur.Clavier)
        self.fenetre.ZoneDeJeu.bind('<Button-1>',self.joueur.creer_projectile)
