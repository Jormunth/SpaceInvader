...
difficulty = 6
ma_fenetre.creer_fenetre(Tk,Canvas,Button,difficulty)
...
ma_fenetre.forme1(60,700,32/2,30,2,ma_fenetre)
...
ma_fenetre.FrameGauche.after(200,ma_fenetre.creerEnemy,difficulty,DY)
ma_fenetre.FrameGauche.after(200,ma_fenetre.deplacementEnemy,vitesse,DY,difficulty,ma_fenetre)
ma_fenetre.FrameGauche.after(200,ma_fenetre.autoTir,difficulty,ma_fenetre)
